...
-- 6. clients (거래처) - 20개
INSERT INTO clients (client_code, client_name, client_name_kr, country_id, client_city, port_id, client_address, client_tel, client_email, payment_term_id, currency_id, client_manager, team_id, client_status, client_reg_date, created_at, updated_at)
