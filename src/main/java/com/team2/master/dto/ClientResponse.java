...
public class ClientResponse {
    ...
    public static ClientResponse from(Client client) {
        return ClientResponse.builder()
                ...
                .countryId(client.getCountry() != null ? client.getCountry().getId() : null)
                .countryName(client.getCountry() != null ? client.getCountry().getCountryName() : null)
                .clientCity(client.getClientCity())
                .portId(client.getPort() != null ? client.getPort().getId() : null)
                ...
                .paymentTermId(client.getPaymentTerm() != null ? client.getPaymentTerm().getId() : null)
                .paymentTermName(client.getPaymentTerm() != null ? client.getPaymentTerm().getPaymentTermName() : null)
                .currencyId(client.getCurrency() != null ? client.getCurrency().getId() : null)
